...
docker build -t "$1"/dotnetcore:1.1.2_"$buildnumber" -t "$1"/dotnetcore:latest_"$buildnumber" 1.1.2
docker build -t "$1"/dotnetcore:2.0.0-preview2_"$buildnumber" 2.0.0-preview2
...
docker push "$1"/dotnetcore:2.0.0-preview2_"$buildnumber"
